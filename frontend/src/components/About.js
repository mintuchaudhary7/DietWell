        ...
        <div className="mt-5 grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <p className="text-gray-700">
              At DietWell, our vision is to create a world where everyone has
              access to reliable nutrition information and support to make
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <p className="text-gray-700">
              Our mission is to provide compassionate, personalized nutrition
              counseling and Diet Plan to individuals seeking to improve their
              health.
            </p>
          </div>
          {/* Values */}
