...
const WeightGain = async (req, res) => {
  try {
    ...
    if (age === null || gender ==="" || height === null || weight === null || bmr === null || disease === "" ||  activity === "" || dietpreference==="" || allergy === "" || disease === "") {
      console.log("Enter your Data and complete your profile");
      res.status(400).json({
        success:false,
        message: "Enter your Data and complete your profile for accurate diet plan"
      })
    }
    ...
    const chatCompletion = await openai.chat.completions.create({
        ...
        functions: [
            {name: "get_diet_plan", "parameters": schema}
        ],
